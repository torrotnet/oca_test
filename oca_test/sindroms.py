...
S_A1_B1_C1_D1_E1_F1_G1_H1_I1_J1 = u'На графике все точки находятся на высоком уровне, но человек не находится в этой ' \
...
S_A1_B34 = 'Вы несчастны и депрессивны, и Ваш взгляд на жизнь пессимистичен. Проблем и тружностей так много, что Вы ' \
           ...
           'и Ваши друзья считают, что им трудно надозиться рядом с Вами.'
S_A1_C34 = 'Вы раздражительны и чрезмерно возбудимы. Ваше беспокойство и возбеждение оказывает негативный эффект ' \
...
S_B1_C34 = 'Вам не хватает спокойствия и способности расслабиться, что приводит к тому, что Вы на самом деле менее ' \
           'счастливы, чем Вы, как правило, считаете. Ваши нерсвные привычки снижают Ваш энтузиазм и интерес к ' \
...
S_E1_D34 = 'Вы ненадежны и не верите в себя. На самом деле Вы не можете решить для себя, какие цели Вы хотите ' \
           'достичь, а какие - нет, хотя Вы достаточно активны. Невсе Ваши действия в действительности ' \
           ...
           'деятельность создаст Вам тружности.'
S_E1_F34 = 'Вы замкнутый и покорный человек. Вы биотесь иметь дело с людьми и сталкиваться с какими-нибудь ' \
           'ситуациями в открытую - только скрытно. Это создаст для Вас много трудностей. То, что Вы настолько ' \
           'активны, но в то же время достаточно замкнуты, говорит о том ,чтто Вы деалете вещи, с которыми на самом ' \
           'деле не можете спарвиться. В будущем это принесет Вам очень много трудностей.'
S_F1_E34 = 'Вы не очень активны, Вы испытываете тружности с тем, чтобы начать какие-либо действия и продолжать их, ' \
           ...
           'Следовательно, из-за Вашей обысной лени Вы не делаете всего того, что Вы реально способны делать, и ' \
...
S_F1_G34 = 'Вы безответственны в жизни и в работе. Вы обвиняете других в том, что происходит с Вами, и не будете ' \
           'признавать никаких мнений о том, чот Вы должны иметь какую бы то ни було ответственность за то, что с ' \
           'Вами происходит или произойдет. Тот факт, что Вы достаточно способны и открыты и тем не менее анстолько ' \
...
S_G1_F34 = 'Вы вовсе не являетесь способным или открытым человеком. Вы в действительности не способны открыто ' \
           ...
           'делает Вас ответственным де некоторой степени, но Вам, как индивидууму, лучше следить за своими ' \
...
S_H1_I34 = 'Вы не способны быть чутким, так как Вы не можете поставить себя на место другого человека и, ' \
           ...
           'восприимчивы, как Вы считаете сами, так как Вы пытаетесь быть частным в Вашем отношении только ' \
...
S_D_highest = 'Эйфория - использует наилучшим образом ситуации, в которых находится. В жизни ' \
              ...
              'достаточно хорошо скрывать это пож маской "со мной все в порядке".'
